...
public class TwoSubjectsSummarizationSecondForm extends TwoSubjectsSummarization {

    private RelativeQuantifier relativeQuantifier;
    private List<LinguisticVariable> qualifiers;

    public TwoSubjectsSummarizationSecondForm(String subject1, String subject2,
    ...
    public double getDegreeOfTruth() {
        ...
        double denominator = meter + 1.0/ earthquakesSubject2.size() *
                compoundSummarizer.intersection(SummarizationHelper.extractFuzzySet(qualifiers)).getCardinality(earthquakesSubject2);
